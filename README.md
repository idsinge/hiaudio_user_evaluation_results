...
This repository contains the results of a **preliminary user evaluation** conducted for the **[Hi-Audio online platform](https://hiaudio.fr)**, with a focus on its practical usability and applicability from the perspective of amateur musicians.
...
Participants were recruited through **La Scène** ([lascene.rezel.net](https://lascene.rezel.net/)), the student music association of Télécom Paris, which received a recruitment support fee of €40 per participant.
